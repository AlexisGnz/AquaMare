    ...
    <div class="container">
      ...
      <div class="menu_header">
        <ul>
          ...
          <li class="active"><a href="trabajos">Trabajos Realizados</a></li>
...
<div class="page_container">
  <div class="inner_page">
    <div class="container">
      ...
      <div class="container">
        ...
        <div class="col-md-3 col-md-3-fix jobs-container">
          ...
          <section class="text-center">
            ...
            <p>Casa de Familia, Resistencia</p>
          </section>
        </div>  
        ...
        <div class="col-md-3 col-md-3-fix jobs-container">
          ...
          <section class="text-center">
            ...
            <p>Complejo Turístico, Paso de la Patria</p>
          </section>
        </div>
      ...
      <div class="text-center container-nav-num">
        <nav class="nav-num">
          <ul>
            <li>1</li>
            <li>2</li>
